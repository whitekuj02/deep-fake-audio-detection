...
if __name__ == "__main__":
    ...
    os.makedirs(os.path.join(args.base_data_path, "data16k_denoised/mix"), exist_ok=True)
    ...
    for _ in tqdm(range(args.mix_samples), desc="Audio mix"):
        ...
        audio1_path = os.path.join(args.base_data_path, f"data16k_denoised/train/{audio1_name}.wav")
        audio2_path = os.path.join(args.base_data_path, f"data16k_denoised/train/{audio2_name}.wav")

        combined_name = f"{audio1_name}-{audio2_name}"
        combined_path = os.path.join(args.base_data_path, f"data16k_denoised/mix/{combined_name}.wav")
    ...
    # 정답 정보를 저장
    with open(os.path.join(args.base_data_path, "data16k_denoised/mix.csv"), "w") as f:
